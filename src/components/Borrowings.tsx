        ...
        {totalPages > 1 && (
          <div className="px-6 py-4 border-t border-slate-100 flex items-center justify-between bg-white">
            <div className="text-sm text-slate-500">
              Menampilkan <span className="font-semibold text-slate-700">{(currentPage - 1) * itemsPerPage + 1}</span> sampai <span className="font-semibold text-slate-700">{Math.min(currentPage * itemsPerPage, filteredBorrowings.length)}</span> dari <span className="font-semibold text-slate-700">{filteredBorrowings.length}</span> peminjaman
            </div>
